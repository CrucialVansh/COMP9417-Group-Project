...
X_test_2: pd.DataFrame = pd.read_csv("./data/X_test_2.csv")
y_test_2: pd.DataFrame = pd.read_csv("./data/y_test_2_reduced.csv")
...
print("LASSO selection weighted log loss: ", selected_ce_score) # ~3.09
